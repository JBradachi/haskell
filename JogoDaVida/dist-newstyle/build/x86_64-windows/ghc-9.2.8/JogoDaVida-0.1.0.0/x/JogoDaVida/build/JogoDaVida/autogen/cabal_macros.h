...
/* package JogoDaVida-0.1.0.0 */
#ifndef VERSION_JogoDaVida
#define VERSION_JogoDaVida "0.1.0.0"
#endif /* VERSION_JogoDaVida */
#ifndef MIN_VERSION_JogoDaVida
#define MIN_VERSION_JogoDaVida(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_JogoDaVida */
...
#define CURRENT_COMPONENT_ID "JogoDaVida-0.1.0.0-inplace-JogoDaVida"
